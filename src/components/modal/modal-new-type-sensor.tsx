...
const ModalNewTypeSensor: React.FC = ({ isOpen, onClose}) => {
    ...
    <Box>
      ...
      >
        <Box sx={{
          ...
          <SignUpFormNewTypeSensor  closeModal={onClose} onRegistrationSuccess={onRegistrationSuccess}/>
        </Box>
      </Modal>
    </Box>
  );
...
export default ModalNewTypeSensor;
